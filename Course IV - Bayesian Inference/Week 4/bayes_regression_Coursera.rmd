...
<div id="instructions">
Complete all **Exercises**, and submit answers to **Questions** on the [Coursera ](https://www.coursera.org/learn/bayesian/exam/hjOGb/week-4-lab)
platform.
</div>
...
8. True or False: The naive model with all variables included has posterior probability greater than 0.5. (Use a Zellner-Siow null prior for the coefficients and a Beta-Binomial (1,1) prior for the models**this is the argument default***)
<ol>
<li> True
<li> ***False***
</ol>
